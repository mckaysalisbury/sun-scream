...
namespace Server
{
    ...
    public static class UniverseGenerator
    {
        ...
        public static Universe GenerateUniverse()
        {
            ...
            universe.AddEntity(new StarSystem(universe.GenerateId(), "The first Star"), new Vector2(10, 10));
            universe.AddEntity(new StarSystem(universe.GenerateId(), "The second Star"), new Vector2(-10, -10));
